...
class OnboardingPageViewController: UIPageViewController {
    private lazy var viewControllersList: [UIViewController] = {
        let vc1 = OnboardingViewController(image: UIImage(named: "Onboarding1")!, headerTitle: "MusicApp: Your favorite tracks in one place", title: "Welcome to MusicApp - a unique music app that offers you a limitless world of music in the palm of your hand", showGetStarted: false, skipDelegate: self, nextDelegate: self)
        let vc2 = OnboardingViewController(image: UIImage(named: "Onboarding2")!, headerTitle: "Explore a variety of genres with MusicApp", title: "MusicApp doesn't just offer a wide range of genres. We strive to make your musical life as rich and interesting as possible. Our app features music from the most diverse corners of the music world", showGetStarted: false, skipDelegate: self, nextDelegate: self)
        
        let vc3 = OnboardingViewController(image: UIImage(named: "Onboarding3")!, headerTitle: "Your musical adventure begins right now", title: "Now that you've familiarized yourself with MusicApp's features, it's time to start enjoying music. Tap 'Get Started' and discover a new world of musical possibilities", showGetStarted: true)
        return [vc1, vc2, vc3]
    }()
